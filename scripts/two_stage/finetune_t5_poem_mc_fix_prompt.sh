...
LR=${1-0.000003}
INIT_CKPT=${2-acc_2000_0.932}

CONFIG_PATH="${WORKING_DIR}/configs/model/cpm2_config.json"
CKPT_PATH="${WORKING_DIR}/results/poem_mc/t5_finetune_lr0.05const_G2_prompt_seed1234_save/${INIT_CKPT}/"

SAVE_PATH="${WORKING_DIR}/results/poem_mc/t5_finetune_lr${LR}const_baselr0.05const_continue_${INIT_CKPT}_fix_prompt/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_poem_mc_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/poem_mc/poem_mc_model_tune_fix_prompt.json"
