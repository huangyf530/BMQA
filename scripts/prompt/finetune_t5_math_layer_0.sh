...
SAVE_PATH="${WORKING_DIR}/results/math/t5_finetune_lr${LR}const_G${GRAD_ACC}_prompt_layer_0/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_math_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/math/math_layer_0.json"
