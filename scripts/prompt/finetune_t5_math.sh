...
HOST_FILE=${WORKING_DIR}/configs/host_files/hostfile-s4-s5
...
SAVE_PATH="${WORKING_DIR}/results/math/t5_finetune_lr${LR}const_G${GRAD_ACC}_prompt_${POS}_seed${SEED}_fix_test_test/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_math_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/math/math_${POS}.json"
