...
SAVE_PATH="${WORKING_DIR}/results/lcqmc/few-shot/lr${LR}_G${GRAD_ACC}_prompt_num${NUM}/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_full_model.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/lcqmc/lcqmc_5_5_0.json"
