...
SAVE_PATH="${WORKING_DIR}/results/lcsts/t5_finetune_lcsts_lr${LR}const_G${GRAD_ACC}_prompt_seed${SEED}_mask_t2p/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_lcsts_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/masks/mask_t2p_10_0_0.json"
