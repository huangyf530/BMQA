...
SAVE_PATH="${WORKING_DIR}/results/math/t5_finetune_lr${LR}const_G${GRAD_ACC}_prompt_seed${SEED}_efficient/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_math_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/math/math_10_0_0.json"
...
CMD="deepspeed -i cgpt-s6:0,1,2,3 --hostfile ${HOST_FILE} ${WORKING_DIR}/finetune_cpm2.py ${OPTS}"
