...
SAVE_PATH="${WORKING_DIR}/results/poem_mc/lr${LR}const_G${GRAD_ACC}_prompt_bs4_num${NUM}_init_vocab_limit1000_gen_temp_fix/seed${SEED}/"
...
OPTS+=" --data-name poem_mc_gen_temp"
