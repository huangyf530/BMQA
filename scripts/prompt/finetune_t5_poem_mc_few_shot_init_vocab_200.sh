...
SAVE_PATH="${WORKING_DIR}/results/poem_mc/lr${LR}const_G${GRAD_ACC}_prompt200_bs4_num${NUM}_init_vocab_limit1000_fix_samp/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_poem_mc_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/poem_mc/poem_mc_init_vocab_200.json"
