...
HOST_FILE=${WORKING_DIR}/configs/host_files/hostfile-${5}
...
SAVE_PATH="${WORKING_DIR}/results/lcqmc/few-shot/lr${LR}_G${GRAD_ACC}_prompt_num${NUM}_init_vocab_limit1000_gentemplate_fix_fix/seed${SEED}/"
