...
DATA_EXT=".json"
DATA_PATH="/dataset/f1d6ea5b/gyx/data/c3"
...
SAVE_PATH="${WORKING_DIR}/results/c3/t5_finetune_lr${LR}const_G${GRAD_ACC}_prompt_seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_c3_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/c3/c3_33_34_33_0.json"
