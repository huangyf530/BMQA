...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/hyf/data_en/QADataset/unified"
...
SAVE_PATH="${WORKING_DIR}/results/squad/fintune/lr${LR}_B${GLOBAL_BATCH_SIZE}_finetune_seed${SEED}_xl"
...
OPTS+=" --load ${SAVE_PATH}/em_12000_0.856"
