...
CKPT_PATH="/mnt/sfs_turbo/gyx/checkpoints/t5-xl-3/t5-MP2/"

SAVE_PATH="${WORKING_DIR}/results/sst2/few-shot/t5_xl-3/full_model_lr${LR}_G${GRAD_ACC}_num32/seed${SEED}/"
