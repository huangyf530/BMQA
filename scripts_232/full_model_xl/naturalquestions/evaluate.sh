...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/hyf/data_en/QADataset/naturalquestions"
...
CKPT_PATH="${WORKING_DIR}/results/squad/fintune/lr0.0001_B32_finetune_seed2021_xl/em_12000_0.856"

SAVE_PATH="${WORKING_DIR}/results/naturalquestions/evaluate_squad_xl"
LOG_FILE="${SAVE_PATH}/eval-log.txt"
...
echo ${CMD}
mkdir -p ${SAVE_PATH}
${CMD} 2>&1 | tee ${SAVE_PATH}/eval_log
