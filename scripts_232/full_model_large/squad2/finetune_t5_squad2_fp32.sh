...
MP_SIZE=1
DATA_PARALLEL_SIZE=`expr $GPUS_PER_NODE / $MP_SIZE`

DATA_EXT=".jsonl"
DATA_PATH="/data1/private/hyf/QADataset/encoded/SQuAD2.0"
...
CKPT_PATH="/data1/private/hyfpretrained_models/cpm-t5/t5-large/t5-MP1"

SAVE_PATH="${WORKING_DIR}/results/squad/fintune/lr${LR}_B${GLOBAL_BATCH_SIZE}_finetune_seed${SEED}_large"
